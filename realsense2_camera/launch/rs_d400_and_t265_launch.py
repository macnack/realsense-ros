...
local_parameters = [{'name': 'camera_name1', 'default': 'D435i', 'description': 'camera unique name'},
                    ...
                    # {'name': 'unite_imu_method1', 'default': 'linear_interpolation', 'description': 'linear_interpolation'},
                    ...
                    # {'name': 'unite_imu_method2', 'default': 'linear_interpolation', 'description': 'linear_interpolation'},
                    ...
                    # {'name': 'enable_fisheye1', 'default': 'false', 'description': 'topic for T265 wheel odometry'},
                    # {'name': 'enable_fisheye2', 'default': 'false', 'description': 'topic for T265 wheel odometry'},
                   ]
